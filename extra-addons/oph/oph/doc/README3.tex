...
\label{sec:emailbloc}
connection en admin (peut etre ca marche en 'lfs'?)
...
'Rule Name': ce que l'on veut
'Related document model': oph.bloc.agenda
onglet'condition': aucune
onglet 'Actions':
'set responsable': vide 'add followers': vide
'servers actions to run' : add les actions définis dans 'Technical / Actions / server Action'
